...
const arr offset_1 = {0.0320426, 0.0433506, 0};
const arr offset_2 = {-0.0333547, 0.0423493, 0};
const arr offset_3 = {-0.0537034,-0.00468403 , 0};
...
//    target->setRelativePosition(dot->getRelativePosition());
#endif
    {
      ...
      move().addObjective({}, FS_positionDiff, {"l_gripper", dot->name /*target*/}, OT_eq, {1e0}, {0.,0., .0125});
      if(!move.go()) return;
    }
